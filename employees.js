...
//CODE HERE
let empOne = new Employee(`Danny`, [`weekday mornings`, `weekday afternoons`])
...
//CODE HERE
let manager = new Manager(`jerk face`, `literally never`,[`StayGolden`, `PonyBoy`])
